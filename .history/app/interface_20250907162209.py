...
# ===========================================================
    ...
    st.text("📄 Resumen detallado:")
    st.text(resultado_ate["Resumen"])
    ...
    st.code(resultado_ate["Resumen_Estimaciones"], language="text")

    st.subheader("📌 Estadísticas Descriptivas")
    st.code(resultado_ate["Resumen_Stats"], language="text")
