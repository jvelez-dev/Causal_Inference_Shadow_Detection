...
# ===========================================================
    ...
    st.markdown("""
                Ahora, para ver qué tan lejos está nuestra hipótesis de ser nula, es el momento de hacer intervenciones; en este caso intervenir el modelo consiste en desaparecer la esfera y ver que pasa con la sombra(B).
                """)
